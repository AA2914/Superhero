...
const handleLogin = async (e)=>{
  ...
  return (
    <div style={{width:'100%',height:'100vh'}} className='d-flex justify-content-center align-items-center'>
         <div className="container w-75" style={{border:'3px solid rgb(158, 142, 70) '}}>
            <div className="card shadow p-2 ">
               <div className="row align-items-center">
                <div className='col-lg-6' >
                    <img className='w-100' src="https://c0.wallpaperflare.com/preview/324/740/911/closeup-communication-computer-connection.jpg" alt="" />
                </div>
                <div className="col-lg-6">
                    <h5 className='fw-bolder mt-2' style={{color:' rgb(158, 142, 70)'}}>
                    ...
                    <Form>
...

                        {
                            insideRegister?
                            <div className="mt-3">
                                <button onClick={handleRegister} className='btn text-light mb-2' style={{backgroundColor:" rgb(158, 142, 70)"}}>Register</button>
                                <p>Already have an Account? Click here to <Link to="/login">Login</Link> </p>
                            </div>
                            :
                            <div className='mt-3'>
                               <button onClick={handleLogin} className='btn text-light mb-2' style={{backgroundColor:" rgb(158, 142, 70)"}}>Login</button>
